...
public class Item {
    ...
    public static int ItemWidth = 90;
    public static int ItemHeight = 72;
     ...
     */
    public Item(Texture region, float startX, float startY) {
        this.position = new Vector2(startX, startY);

        this.sprite = new Sprite(region);
        this.sprite.setPosition(position.x, position.y);
        this.sprite.setSize(ItemWidth, ItemHeight);
